...
export { project, eligibleStarts, withEffectiveMemory, NUNC_CARRIER_MARK, type CarrierTag, MANUAL_MEMORY_TYPE, memoryRevision, revisionApplies } from "./projection.js";
