...
f.response = (row, source) => source ? JSON.stringify({ add: [], remove: [], priority: source.M.map(s => s.id), required: [] }) : (() => { assert(steps.length, 'scripted native service inventory exceeded'); return steps.shift(); })();
