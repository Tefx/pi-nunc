...
| `tests/live` | Default-resolution and named-override stdin, no-call preflight, target/build binding, quotas/failure/unknown usage, actual stock RPC/tools/calibrated rollovers/restart, child termination, cleanup and prerequisite-gated artifact checks. |
