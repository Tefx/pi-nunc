...
| `scripts/observe-grok-budget.mjs` | Stock Grok 500k catalog, native Responses output sizing, fixed raw extraction, native checkpoint continuation and oversized zero-send (controlled loopback service). |
