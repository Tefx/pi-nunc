...
| `tests/live` | Default-resolution and named-override stdin, no-call preflight, target/build binding, quotas/failure/unknown usage, actual stock RPC/tools/calibrated rollovers/restart, c4/full vs original capacity isolation, complete giant exposure/extraction/retirement, late-D steer during outstanding maintenance, cancelled-maintenance non-continuation, child termination, cleanup and prerequisite-gated artifact checks. |
