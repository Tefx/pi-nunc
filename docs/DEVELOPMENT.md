...
| `scripts/observe-lifecycle.mjs` | Three legal overlapping checkpoints, actual restart/reload, model/tree/fork/clone/new, threshold/manual/disabled-auto behavior, provider replacement, unknown contexts/calls, payload/sampling rejection, captured-native dispatch, bounded failures. |
